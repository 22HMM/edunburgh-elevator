...
<main class="products">
    ...
    <div class="container wrapper">
        <div class="row">
            <div class="col-md-4 col-lg-4 col-xl-3 pe-3">
                <ul class="items">
                    <li class="sub-title">
            ...
            <div class="col-md-8 col-lg-8 col-xl-9 main-content">
                <h3 class="heading">
                        ...
                        <div class="row pb-5">
                            ...
                            <div class="mt-2 col-md-12">
                                ...
                                <span>
                                    ...
                                    (19-inch + 12.2-inch), Car Door Side Display (Grow 93)
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row pt-5 gap-5 main-content">
                    <div class="col-md-4 pb-5">
                        <img src="./images/high-end-car-p4.png" alt="product4" class="w-100">
                    </div>
                ...
                <div class="row pt-5 gap-5 main-content">
                    <div class="col-md-4 pb-5">
                        <img src="./images/high-end-car-p5.png" alt="product5" class="w-100">
                    </div>
                ...
                <div class="row pt-5 gap-5 main-content">
                    <div class="col-md-4 pb-5">
                        <img src="./images/high-end-car-p6.png" alt="product6" class="w-100">
                    </div>
                    <div class="col-md-6 pb-5 mb-4">
                        <div class="row">
                ...
                <div class="row pt-5 gap-5 main-content">
                    <div class="col-md-4 pb-5">
                        <img src="./images/high-end-car-p7.png" alt="product7" class="w-100">
                    </div>
                    <div class="col-md-6 pb-5 mb-4">
                        <div class="row">
                ...
                <div class="row pt-5 gap-5 main-content">
                    <div class="col-md-4 pb-5">
                        <img src="./images/high-end-car-p8.png" alt="product8" class="w-100">
                    </div>
                    <div class="col-md-6 pb-5 mb-4">
                        <div class="row">
